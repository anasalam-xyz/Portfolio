export default function About() {
    return (
        <section id="about" className="mt-20 w-full flex flex-col gap-4">
            ...
            <div className="my-6 flex flex-col md:flex-row justify-between">
                ...
                <div className="md:w-[50%] px-6 flex flex-col justify-between">
                    <div className="px-10 grid grid-cols-3 gap-2 md:gap-4">
                    ...
                    <div className="text-end w-full px-4 py-4 bg-gradient-to-l from-gray-100 to-white p-6 text-white border-r border-gray-400">
