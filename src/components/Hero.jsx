...
export default function Hero() {
    return (
        <section id="home" className="w-full flex flex-col md:flex-row justify-between">
            <div>
                <div className="fade-up delay-1 flex items-center gap-2 bg-gray-100 text-gray-700 rounded-full px-4 py-2 w-fit">
                    <span className="w-2 h-2 bg-emerald-500 rounded-full"></span>
                    <span className="text-sm font-light">Available for work</span>
                </div>
                <div className="fade-up delay-2 my-4 md:my-12">
            ...
            <div className="fade-up delay-5 my-8 md:my-16 flex flex-row md:flex-col items-center gap-6 text-sm text-gray-500 md:self-end self-start">
                ...
                <a href="https://github.com/anasalam-xyz" target="_blank" className="flex items-center md:flex-col gap-1 hover:text-black hover:scale-102 transition-all duration-200 ease-out hover:-translate-y-1 md:hover:-translate-x-1">
                    ...
                    <FaGithub className="-rotate-90"/>
                    <span className="md:hidden">GitHub</span>
                </a>
                <a href="mailto:anasalam.xyz@gmail.com" target="_blank" className="flex items-center md:flex-col gap-1 hover:text-black hover:scale-102 transition-all duration-200 ease-out hover:-translate-y-1 md:hover:-translate-x-1">
                    <span className="hidden md:block vertical-text">Mail</span>
                    <IoMdMail className="-rotate-90"/> 
